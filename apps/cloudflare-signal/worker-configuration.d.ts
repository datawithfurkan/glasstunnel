/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=test/wrangler.jsonc` (hash: 9c5db2ad828f5a696b2d695413fe66d8)
// Runtime types generated with workerd@1.20260721.1 2026-04-19 
interface __BaseEnv_Env {
	...
	SIGNALING_HUB: DurableObjectNamespace<import("./src/index").SignalingHub>;
	RELAY_HUB: DurableObjectNamespace<import("./src/index").RelayHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SignalingHub" | "RelayHub";
	}
