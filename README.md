...
notarized `0.1.10` public beta release is available through GitHub Releases and Homebrew.

The public-beta support tiers are:

- **Supported:** Mac Screen and the scoped Terminal shell path.
- **Preview:** Codex desktop, Codex CLI, Claude desktop, Claude Code, Cursor, Cursor Agent, Gemini CLI, and OpenCode.
