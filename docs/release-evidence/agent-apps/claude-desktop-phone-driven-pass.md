...
stages and their follow-ups (pull requests #32-#36); both browsers passed on the
first attempt with the installed Glasstunnel app running and the maintainer's
phone left alone.
