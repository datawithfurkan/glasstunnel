...
- Result: pass
- Environment: notarized 0.1.9 release build installed over the published 0.1.8 app on macOS 26.6.2
...
The notarized `0.1.9` app, installed over `0.1.8` by dragging it into Applications,
...
Grant action. The Codex, Claude, and Cursor cards, which depend on Accessibility, stay
offered in the Mac app. Gate tests still cover the missing-permission and disabled
Continue states.
